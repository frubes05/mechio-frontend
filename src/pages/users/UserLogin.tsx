...
const UserLogin = ({
  ...
  const onSubmit = async (data: any) => {
    ...
    await getUser.handleFetch(
      `https://mechio-api-test.onrender.composloprimci/odredeni-posloprimac/${email}`
    );
    await loginUser.handleFetch(
      "https://mechio-api-test.onrender.composloprimci/login-posloprimac",
      {
        email,
        password
      }
  ...
  const loginUser = useFetch({
    url: `https://mechio-api-test.onrender.composloprimci/login-posloprimac`,
    method: "post",
    onSuccess: (data) => {
