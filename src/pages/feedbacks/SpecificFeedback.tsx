...
const SpecificFeedback = () => {
  ...
  const getCompanies = useFetch({
    url: `https://mechio-api-test.onrender.composlodavci/${params.id}`,
    method: "get",
    onSuccess: (data: any) => {
      setCompany(data);
    },
  ...
  const getFeedbacks = useFetch({
    url: `https://mechio-api-test.onrender.comrecenzije/${params.id}`,
    method: "get",
    onSuccess: (data: any) => {
  ...
  const submitFeedback = useFetch({
    url: "https://mechio-api-test.onrender.comrecenzije/nova-recenzija",
    method: "post",
    onSuccess: (data: any) => {
      getFeedbacks.handleFetch(`https://mechio-api-test.onrender.comrecenzije/${params.id}`);
      GTMTrackingHelper(
        "Klik",
        "Dodana recenzija",
        "Recenzije",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if ((token?._id || state?._id) && company?._id) {
      ...
      submitFeedback.handleFetch(
        "https://mechio-api-test.onrender.comrecenzije/nova-recenzija",
        feedback
      );
      setPosition("");
      setNegatives("");
  ...
  const handleDelete = (id: string) => {
    ...
    deleteFeedback.handleFetch(
      `https://mechio-api-test.onrender.comrecenzije/izbrisi/${company?._id}/${id}`
    );
  };
